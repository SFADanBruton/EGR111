...
float temperature = 0;            //variable to store the temperature from the temperature sensor
...
void setup()
{
  ...
  Serial.print("Test");     //test the serial connection
}
...
void loop()
{
      ...
      //test turn to the right
      rightMotor(-100);
      leftMotor(100);    
      delay(turnTime);

      //test turn to the left
      rightMotor(100);
      leftMotor(-100);    
      delay(turnTime);
